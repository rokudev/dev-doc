...
- [Channel Behavior Analysis tool](doc:channel-behavior-analysis-tool): Verifies that the app meets performance and deep linking requirements. This tool may be used for SVOD, AVOD, and free apps.
