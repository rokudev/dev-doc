...
* [Channel Behavior Analysis tool](doc:channel-publishing-guide.md#channel-behavior-analysis-window): For SVOD, AVOD, and free channels, verifies channel performance and deep linking meets certification requirements.
