...
Unless the app overrides it, all Roku players will launch an **Options overlay menu** when the ![roku815px - CCSupport2](https://image.roku.com/ZHZscHItMTc2/CCSupport2.png "CCSupport2")key is
...
replay button ![roku815px - CCSupport4](https://image.roku.com/ZHZscHItMTc2/CCSupport4.png "CCSupport4") in the
