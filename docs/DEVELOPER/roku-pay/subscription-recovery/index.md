...
| **Grace period5**                 | Yes (3 days). Access remains while Roku notifies the user. Subscription is canceled 6after 3 days if payment fails.                                                                                                         | Yes (3 days). After 3 days, subscription is placed on **hold**. Access is blocked during hold. Canceled after 60 days if payment fails. |
| **On-screen notifications**       | No                                                                                                                                                                                                                          | Yes                                                                                                                                     |
| **Push notifications**            | Yes                                                                                                                                                                                                                         | Yes                                                                                                                                     |
| **Billing period (if recovered)** | Remains the same                                                                                                                                                                                                            | Resets to the actual payment date                                                                                                       |
| **Documentation**                 | [Basic recovery guide](docs:basic-recovery)                                                                                                                                                                                 | [Enhanced recovery guide](doc:subscription-on-hold)                                                                                     |
