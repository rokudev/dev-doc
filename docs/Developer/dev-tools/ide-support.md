...
Quickly find errors in your app application with our built in color
...
2.  Download the latest version of the Eclipse Installer *(currently
    version “2020-12/R”)* for Java IDE Developers:
