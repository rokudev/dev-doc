...
> To run the app launch performance test, your app application must have the required [AppLaunchComplete signal beacon](/docs/developer-program/performance-guide/measuring-channel-performance.md).
