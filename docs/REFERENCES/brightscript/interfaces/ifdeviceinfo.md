...
Checks whether the device has a Wi-Fi or wired connection, or if it is not connected through any type of network.
...
| default                                                                                | A flag indicating whether the default Wi-Fi connection is being used.                                                                                                                                                                                                                    |
...
| protocol                                                                               | The Wi-Fi protocol name (IEEE 802.11g).                                                                                                                                                                                                                                                  |
...
| ssid                                                                                   | The service set identifier (SSID). The name of the Wi-Fi network to which the device is connected.                                                                                                                                                                                       |
