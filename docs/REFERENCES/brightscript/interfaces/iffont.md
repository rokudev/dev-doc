...
| --------------- | ------- | --------------------------- | --------------------------- | ------------------------------------------------------------ |
| GetOneLineWidth | Integer | ${GetOneLineWidthParameter} | Number of pixels as Integer | Returns the width in pixels occupied by the text (this is capped at the maximum provided value). |

{#GetOneLineWidthParameter}
