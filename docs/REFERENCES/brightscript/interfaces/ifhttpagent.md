...
| secure<br /><br />*Available since Roku OS 12.0* | Boolean | Indicates whether the cookie is to be retrieved via HTTPS (true) or HTTP (false). |
...
| Name    | Type   | Description                                                  |
| ------- | ------ | ------------------------------------------------------------ |
| cookies | Object | An roArray of roAssociativeArrays, where each associative array represents a cookie to be added. Each associative array must contain the following key-value pairs: ${addcookiesparamTable} |

{#addcookiesparamTable}
...
| Value                                            | String     | Value of the cookie                                          |
| Expires                                          | roDateTime | Cookie expiration date, if any                               |
| Secure<br /><br />*Available since Roku OS 12.0* | Boolean    | Indicates whether the cookie is to be sent over HTTPS (true) or HTTP (false). |
