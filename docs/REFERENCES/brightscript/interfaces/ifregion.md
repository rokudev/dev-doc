...
| Name | Type    | Description                                                  |
| ---- | ------- | ------------------------------------------------------------ |
| mode | Integer | The scaling mode, which may be one of the following values: ${setscalemodevalues} |
...
| Name          | Type    | Description                                                  |
| ------------- | ------- | ------------------------------------------------------------ |
| collisiontype | Integer | The collision type, which may be one of the following values: ${setcollisiontype} |
