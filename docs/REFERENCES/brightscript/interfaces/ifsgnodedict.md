...
| ---------- | ------- | ----------------------- | --------------- | --------------------- |
| isSameNode | Boolean | ${issamenodeparamTable} | True/False      | Returns a Boolean value indicating whether the RoSGNode parameter refers to the same SceneGraph node object as the subject node |

{#issamenodeparamTable}
...
| Name  | Return Type   | Parameters         | Return Value | Description           |
| ----- | ------ | ------------------ | --------------- | --------------------- |
| clone | Object | ${cloneparamTable} | Node tree       |  |
