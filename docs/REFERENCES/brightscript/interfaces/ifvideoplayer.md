...
| Name  | Type    | Description                                                  |
| ----- | ------- | ------------------------------------------------------------ |
| level | Integer | The level to which CGMS is set. This may be one of the following values: ${SetCGMSValues} |
...
| Format                      | String | Contains the format of the currently playing video stream.<br/><br/>${video-format} |
