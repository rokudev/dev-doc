...
[Animation Markup](https://github.com/rokudev/samples/tree/master/ux%20components/lists%20and%20grids/PosterGridExampleanimation-markup.md "Animation Markup") in the [SceneGraph Samples](https://github.com/rokudev/samples/tree/master/ux%20components/lists%20and%20grids/PosterGridExampleoverview.md "SceneGraph Samples") provides several simple examples of Animation node definitions that use all of the field interpolator nodes. Other simple examples of using the field interpolators can be found in the [FloatFieldInterpolator](doc:floatfieldinterpolator), [Vector2DFieldInterpolator](doc:vector2dfieldinterpolator), and [ColorFieldInterpolator](doc:colorfieldinterpolator).
