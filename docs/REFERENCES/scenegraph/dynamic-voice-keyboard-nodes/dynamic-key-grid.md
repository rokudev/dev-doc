...
<td>""</td>
<td>READ_WRITE</td>
<td>Specifies the <a href="/docs/references/scenegraph/dynamic-voice-keyboard-nodes/key-definition-file.md">Key Definition File </a> to use to define the key layout metadata.</td>
</tr>
<tr>
<td>mode</td>
<td>string</td>
