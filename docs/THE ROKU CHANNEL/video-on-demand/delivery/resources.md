...
metadata:
  robots: index
---
## Metadata Templates, Schemas, and Samples

| Resource                                | Link                                                                         |
| --------------------------------------- | ---------------------------------------------------------------------------- |
| Film Metadata Excel Template            | [go.roku.com/film-excel-template](https://go.roku.com/film-excel-template)   |
| TV Metadata Excel Template              | [go.roku.com/tv-excel-template](https://go.roku.com/tv-excel-template)       |
| Clip Metadata Excel Template            | [go.roku.com/clip-excel-template](https://go.roku.com/clip-excel-template)   |
| Film XML Schema                         | [go.roku.com/film-xml-schema](https://go.roku.com/film-xml-schema)           |
| TV XML Schema                           | [go.roku.com/tv-xml-schema](https://go.roku.com/tv-xml-schema)               |
| Clip XML Schema                         | [go.roku.com/clip-xml-schema](https://go.roku.com/clip-xml-schema)           |
| Annotated Film XML                      | [go.roku.com/film-xml-example](https://go.roku.com/film-xml-example)         |
| Annotated TV XML                        | [go.roku.com/tv-xml-example](https://go.roku.com/tv-xml-example)             |
| Annotated Clip XML                      | [go.roku.com/clip-xml-example](https://go.roku.com/clip-xml-example)         |
| Film ADI XML Example                    | [go.roku.com/film-adi-xml-example](https://go.roku.com/film-adi-xml-example) |
| TV ADI XML Example                      | [go.roku.com/tv-adi-xml-example](https://go.roku.com/tv-adi-xml-example)     |
| Clip ADI XML Example                    | [go.roku.com/clip-adi-xml-example](https://go.roku.com/clip-adi-xml-example) |
| All Metadata Templates/Examples/Schemas | [go.roku.com/metadata-docs](https://go.roku.com/metadata-docs)               |

## Best Practices and Guides

| Resource                                  | Link                                                                                                                               |
| ----------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| Best Practices: Content Tags and Metadata | [developer.roku.com — content-tags-and-metadata](https://developer.roku.com/trc-docs/video-on-demand/content-tags-and-metadata.md) |
| Music Cue Sheet Submission                | [go.roku.com/music-cue-sheet-submission](https://go.roku.com/music-cue-sheet-submission)                                           |
...
| Resource              | Link                                                                                                                              |
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| US MPAA Ratings       | [filmratings.com](https://www.filmratings.com/)                                                                                   |
| US TV Ratings         | [tvguidelines.org](http://tvguidelines.org/)                                                                                      |
| UK BBFC Ratings       | [bbfc.co.uk](https://bbfc.co.uk/)                                                                                                 |
