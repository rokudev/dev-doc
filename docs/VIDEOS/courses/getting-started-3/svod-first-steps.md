...
This video explains the first steps for [monetizing content](doc:monetization) on the Roku streaming platform with a subscription app. It is intended for publishers and content owners who are new to Roku and are ready to distribute their content to Roku's global audience of over 50 million active user accounts.
...
After watching this video, publishers can complete the initial requirements and then begin developing their subscription app with the [Roku SDK](doc:getting-started). The [Resources](#resources) section includes links to the Roku documentation, Roku developer tools, online video course, master sample app, and other useful material to help publishers get started.
