...
- **Online**: Select a lesson from the left sidebar and then click anywhere on the video player at the top of the page to start watching.
  ...
  ![rsg-overview](https://image.roku.com/ZHZscHItMTc2/rsg-couse-unit1.jpg  "rsg-overview")


- **YouTube**: Go to http://go.roku.com/roku-dev-youtube.

   ![rdp-channel-youtube](https://image.roku.com/ZHZscHItMTc2/roku-dev-youtube-v2.jpg)
